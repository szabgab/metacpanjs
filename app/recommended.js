metacpan.recommended = {
	'async'           : [ 'POE', 'AnyEvent', 'AnyEvent::HTTP', 'IO::Async' ],
    'cgi'             : [ 'CGI', 'CGI::Simple', 'CGI::Session', 'CGI::Application' ],
	'csv'             : [ 'Text::CSV', 'Text::CSV_XS', 'Spreadsheet::Read' ],
	...
	'database'        : [ 'DBI', 'DBIx::Class', 'DBD::mysql', 'DBD::SQLite', 'MongoDB', 'DBD::Oracle', 'DBD::Sybase', 'DBD::Pg', 'DBD::ODBC', 'DBD::CSV', 'DBD::DB2' ],
	'date-time'       : [ 'DateTime', 'DateTime::Tiny', 'DateTime::Format::Strptime', 'DateTime::TimeZone', 'DateTime::Duration', 'DateTime::Format::ISO8601', 'DateTime::Format::MySQL', 'DateTime::Format::DateParse' ],
	'email'           : [ 'Email::Valid', 'Email::Stuffer', 'Email::Sender' ],
	'excel'           : [ 'Spreadsheet::Read', 'Spreadsheet::ParseExcel', 'Spreadsheet::WriteExcel', 'Spreadsheet::XLSX', 'Spreadsheet::ParseXLSX'  ],
	'exception'       : [ 'Try::Tiny' ],
	'json'            : [ 'JSON::MaybeXS', 'Mojo::JSON', 'JSON' ],
	...
	'web-crawling'    : [ 'WWW::Mechanize', 'LWP::UserAgent', 'LWP::Simple', 'WWW::Selenium', 'WWW::Mechanize::Firefox' ],
